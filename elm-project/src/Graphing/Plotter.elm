    ...
    div
        ...
        [ -- div
          ...
          div
            ...
            [ let
                lineSegments =
                    panelEntry.evaluatedPlotValues

                -- |> Debug.log "evaluatedPlotValues"
              in
    ...
    let
        ...
        mappingFunc colorVaryParam =
            let
                ...
                r =
                    helperFunc shadingRange.minRed shadingRange.maxRed colorVaryParam

                g =
                    helperFunc shadingRange.minGreen shadingRange.maxGreen colorVaryParam

                b =
                    helperFunc shadingRange.minBlue shadingRange.maxBlue colorVaryParam
            in
            Color.rgb255 r g b
    in
    mappingFunc
